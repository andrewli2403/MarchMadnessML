...
matchup(teams['NorfolkState'], teams['AppalachianState'])
matchup(teams['WichitaState'], teams['Drake'])
matchup(teams['MountStMary'], teams['TexasSouthern'])
matchup(teams['MSU'], teams['UCLA' ])
